...
public class SortToolsTest {
    ...
    public void findTest5() {
        int[] x = new int[] {0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172, 176, 180, 184, 188, 192, 196, 200, 204, 208, 212, 216, 220, 224, 228, 232, 236, 240, 244, 248, 252, 256, 260, 264, 268, 272, 276, 280, 284, 288, 292, 296, 300, 304, 308, 312, 316, 320, 324, 328, 332, 336, 340, 344, 348, 352, 356, 360, 364, 368, 372, 376, 380, 384, 388, 392, 396};
        int[] original = x.clone();
        int n = x.length;
        int v = 8;
    ...
    public void copyAndInsertTest4() {
        int[] x = new int[] {-100, -96, -92, -88, -84, -80, -76, -72, -68, -64, -60, -56, -52, -48, -44, -40, -36, -32, -28, -24, -20, -16, -12, -8, -4, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172, 176, 180, 184, 188, 192, 196, 200, 204, 208, 212, 216, 220, 224, 228, 232, 236, 240, 244, 248, 252, 256, 260, 264, 268, 272, 276, 280, 284, 288, 292, 296};
        int[] original = x.clone();
        int[] solution = new int[] {-100, -96, -92, -88, -84, -80, -76, -72, -68, -64, -60, -56, -52, -48, -44, -40, -36, -32, -28, -24, -20, -16, -12, -8, -4, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104, 108, 112, 116, 120, 123, 124, 128, 132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172, 176, 180, 184, 188, 192, 196, 200, 204, 208, 212, 216, 220, 224, 228, 232, 236, 240, 244, 248, 252, 256, 260, 264, 268, 272, 276, 280, 284, 288, 292, 296};
        int n = x.length;
        int v = 123;
        int[] output = SortTools.copyAndInsert(x, n, v);
        assertArrayEquals(solution, output);
    ...
    @Test
        ...
        assertEquals(true, SortTools.isSorted(x, n+1));
        }
    ...
    @Test
        ...
        int[] x = new int[] {86, 52, 13, 79, 56, 76, 85, 29, 16, 47, 95, 80, 33, 24, 84, 81, 18, 45, 74, 63, 10, 98, 85, 60, 92, 77, 60, 37, 53, 32, 64, 12, 58, 18, 4, 16, 44, 82, 22, 99, 1, 58, 82, 2, 28, 65, 27, 51, 62, 57, 56, 44, 71, 15, 27, 88, 82, 9, 74, 4, 69, 95, 12, 17, 70, 72, 74, 34, 43, 28, 42, 79, 90, 56, 37, 29, 21, 35, 45, 58, 38, 34, 51, 7, 43, 12, 60, 37, 19, 64, 54, 55, 94, 19, 2, 33, 39, 57, 42, 49};
        int n = x.length;
        SortTools.insertSort(x, n);
        assertEquals(true, SortTools.isSorted(x, n));
        }
